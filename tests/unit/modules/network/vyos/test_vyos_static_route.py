...
from ansible_collections.vyos.vyos.plugins.modules import _vyos_static_route
...
class TestVyosStaticRouteModule(TestVyosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.vyos.vyos.plugins.modules._vyos_static_route.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.vyos.vyos.plugins.modules._vyos_static_route.load_config')
