...
class TestVyosFactsModule(TestVyosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.vyos.vyos.plugins.module_utils.network.vyos.facts.legacy.base.run_commands')
        ...
        self.mock_get_capabilities = patch('ansible_collections.vyos.vyos.plugins.module_utils.network.vyos.facts.legacy.base.get_capabilities')
